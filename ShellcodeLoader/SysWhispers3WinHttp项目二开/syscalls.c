	...
	IN ULONG Protect)
{
	asm(
		...
		"lea esp, [esp+4] \n"
		"mov ecx, 0x6 \n"
	"push_argument_3D952B7B: \n"
		"dec ecx \n"
		"push [ebp + 8 + ecx * 4] \n"
		"jnz push_argument_3D952B7B \n"
		"mov ecx, eax \n"
		"mov eax, ecx \n"
		"lea ebx, [ret_address_epilog_3D952B7B] \n"
		"push ebx \n"
		"call do_sysenter_interrupt_3D952B7B \n"
		"lea esp, [esp+4] \n"
	"ret_address_epilog_3D952B7B: \n"
		"mov esp, ebp \n"
		"pop ebp \n"
		"ret \n"
	"do_sysenter_interrupt_3D952B7B: \n"
		"mov edx, esp \n"
		"jmp edi \n"
		"ret \n"
	);
	...
	OUT PULONG OldProtect)
{
	asm(
		...
		"lea esp, [esp+4] \n"
		"mov ecx, 0x5 \n"
	"push_argument_0E1242D7: \n"
		"dec ecx \n"
		"push [ebp + 8 + ecx * 4] \n"
		"jnz push_argument_0E1242D7 \n"
		"mov ecx, eax \n"
		"mov eax, ecx \n"
		"lea ebx, [ret_address_epilog_0E1242D7] \n"
		"push ebx \n"
		"call do_sysenter_interrupt_0E1242D7 \n"
		"lea esp, [esp+4] \n"
	"ret_address_epilog_0E1242D7: \n"
		"mov esp, ebp \n"
		"pop ebp \n"
		"ret \n"
	"do_sysenter_interrupt_0E1242D7: \n"
		"mov edx, esp \n"
		"jmp edi \n"
		"ret \n"
	);
	...
	IN PPS_ATTRIBUTE_LIST AttributeList OPTIONAL)
{
	asm(
		...
		"lea esp, [esp+4] \n"
		"mov ecx, 0xb \n"
	"push_argument_F4A9C216: \n"
		"dec ecx \n"
		"push [ebp + 8 + ecx * 4] \n"
		"jnz push_argument_F4A9C216 \n"
		"mov ecx, eax \n"
		"mov eax, ecx \n"
		"lea ebx, [ret_address_epilog_F4A9C216] \n"
		"push ebx \n"
		"call do_sysenter_interrupt_F4A9C216 \n"
		"lea esp, [esp+4] \n"
	"ret_address_epilog_F4A9C216: \n"
		"mov esp, ebp \n"
		"pop ebp \n"
		"ret \n"
	"do_sysenter_interrupt_F4A9C216: \n"
		"mov edx, esp \n"
		"jmp edi \n"
		"ret \n"
	);
	...
	IN PLARGE_INTEGER Timeout OPTIONAL)
{
	asm(
		...
		"lea esp, [esp+4] \n"
		"mov ecx, 0x5 \n"
	"push_argument_2F3207AF: \n"
		"dec ecx \n"
		"push [ebp + 8 + ecx * 4] \n"
		"jnz push_argument_2F3207AF \n"
		"mov ecx, eax \n"
		"mov eax, ecx \n"
		"lea ebx, [ret_address_epilog_2F3207AF] \n"
		"push ebx \n"
		"call do_sysenter_interrupt_2F3207AF \n"
		"lea esp, [esp+4] \n"
	"ret_address_epilog_2F3207AF: \n"
		"mov esp, ebp \n"
		"pop ebp \n"
		"ret \n"
	"do_sysenter_interrupt_2F3207AF: \n"
		"mov edx, esp \n"
		"jmp edi \n"
		"ret \n"
	);
